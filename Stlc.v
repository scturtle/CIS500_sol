...
Proof with auto.
  ...
  repeat apply T_Abs.
  eapply T_App. apply T_Var.
  rewrite extend_neq by (intro c; inversion c).
  rewrite extend_eq...
  eapply T_App. apply T_Var.
  rewrite extend_neq by (intro c; inversion c).
  rewrite extend_neq by (intro c; inversion c).
...
Example typing_nonexample_3 :
  ~ (exists S, exists T,
        empty |- 
          ...
          T).
Proof.
  intro Hc; inversion Hc as [S H]; clear Hc.
  inversion H as [T H0]; subst; clear H.
  ...
  inversion H4; subst; clear H4.
  inversion H1.
  (* following are quite wierd... *)
  induction T11. inversion H0.
  inversion H0.
  apply IHT11_1. rewrite extend_eq.
