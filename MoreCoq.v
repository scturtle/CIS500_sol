...
Proof.
  ...
  assert (H: forall x : X, forall l1 l2 : list X,
               length (l1 ++ x :: l2) = S (length (l1 ++ l2))).
    intros x l1.
    induction l1. reflexivity.  
    intros l2. simpl. apply f_equal. rewrite IHl1. reflexivity. 
...
Theorem existsb_eq: forall (X : Type) (test : X -> bool)
                           (l : list X),
...
(* $Date: 2014-02-04 05:15:43 -0700 (Tue, 04 Feb 2014) $ *)
